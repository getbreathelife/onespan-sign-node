...
[Home](./index.md) &gt; [onespan-sign-node](./onespan-sign-node.md) &gt; [OneSpanSign](./onespan-sign-node.onespansign.md) &gt; [uploadDocument](./onespan-sign-node.onespansign.uploaddocument.md)

## OneSpanSign.uploadDocument() method
...
|  payload | [UploadDocumentRequestPayload](./onespan-sign-node.uploaddocumentrequestpayload.md) | Metadata of the to-be-uploaded document |
|  documentBody | Buffer \| ReadableStream | Data of the document |
