...
|  [search?](./onespan-sign-node.requests.getallpackagesparameters.search.md) | string | <i>(Optional)</i> Any text which is going to be used in conjunction with the  if provided. |
